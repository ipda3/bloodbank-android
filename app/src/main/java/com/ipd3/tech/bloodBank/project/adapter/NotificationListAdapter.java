...
public class NotificationListAdapter extends RecyclerView.Adapter<NotificationListAdapter.ViewHolder> {
    ...
    private void setData(ViewHolder holder, int position) {
        try {
            ...
            holder.notificationListAdapterTvNotificationText.setText(notificationsData.get(position).getCreatedAt());
            holder.notificationListAdapterTvNotificationTime.setText(notificationsData.get(position).getTitle());

            if (notificationsData.get(position).getPivot().getIsRead().equals("0")) {
        ...
        try {
            ...
            holder.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    getDonation(activity, apiServices, notificationsData.get(position).getDonationRequestId(), userData.getApiToken());
                }
            });
