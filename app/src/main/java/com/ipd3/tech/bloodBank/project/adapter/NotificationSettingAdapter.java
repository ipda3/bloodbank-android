package com.ipd3.tech.bloodBank.project.adapter;
...
public class NotificationSettingAdapter extends RecyclerView.Adapter<NotificationSettingAdapter.ViewHolder> {
    ...
    private void setData(ViewHolder holder, int position) {
        ...
        try {
            ...
            holder.notificationSettingAdapterCbSettingCheck.setChecked(false);
            ...
            holder.notificationSettingAdapterCbSettingCheck.setText(bloods.get(position).getName());
    ...
    private void setAction(ViewHolder holder, int position) {
        ...
        try {
            ...
            holder.notificationSettingAdapterCbSettingCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.notification_setting_adapter_cb_setting_check)
        CheckBox notificationSettingAdapterCbSettingCheck;
        private View view;
